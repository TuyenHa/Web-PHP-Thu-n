				...
				<div class="panel-body">
					...
					if(isset($_POST['ok']))
					{
						...
						if($fileTmptName!=null){
							...
							$update1="UPDATE sanpham SET ten_san_pham='$tensanpham',id_danh_muc='$danhmuc',gia='$gia',mo_ta='$mota',so_luong='$soluong',bao_hanh='$baohanh',khuyen_mai='$khuyenmai',ngay_nhap='$ngay_nhap',tinh_trang='$tinhtrang',dac_biet='$dacbiet',anh_san_pham='$fileName' WHERE id_san_pham='$id'";
							$query1=mysql_query($update1);
							if($query1){
								?>
								<script language="javascript">
									window.alert("Sửa thành công");
									window.location="index.php?content=products";
								</script>
								<?php
							}else{
								echo '<div class="alert bg-danger" role="alert">
